...
public abstract class UserReg extends AppCompatActivity {
    ...
    abstract public boolean isExistAdmin();

    abstract public boolean isExistUserName(String strUserName);
